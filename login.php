                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form id="login_form" method="POST" action='php/login_user.php'>
                                            <?=$query_error == false ? '' : '<div class="form-floating mb-3 error">'.$query_error.'</div>'?>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputUsername" name="inputUsername" type="text" placeholder="Your username" />
